# 💰 JenBot Economy: Income Mechanisms

This document outlines all available methods for users to acquire **JenCoins (JC)** and **Gold**, including yields, success rates, and modifiers.
...
### 5. 📦 High-Stakes Mystery Boxes
**Cost**: 1,000 JC per box.
| Rarity | Chance | JC Yield | Bonus Items |
| :--- | :--- | :--- | :--- |
...
- **Gold Theft**: 50% chance on success to steal 20-30% of target's Gold.
- **VIP Target**: -10% Success Rate (Harder to rob VIPs).

---

### 7. 📈 Market Investments
| Asset | Yield | Strategy | Fees |
| :--- | :--- | :--- | :--- |
| **`Gold`** | Market Growth | Buy Low, Sell High | 5% Trade Fee (2% VIP). |

---

> [!TIP]
> **VIP Status** (10,000 JC / 30 days) is the most efficient way to maximize income by drastically reducing taxes and trade fees across all modules.
